...
async function request(path, opts = {}) {
  ...
  const res = await fetch("http://127.0.0.1:8003/api" + path, Object.assign({}, opts, { headers }))
...
export default {
  ...
  async createCheckoutSession() {
    return request('/payment/create-checkout-session', { method: 'POST', headers: { 'Content-Type': 'application/json' } })
  }
}
